...
class GetEarliestTests(unittest.TestCase):
    ...
    def test_many_dates_treys_solution(self):
        d1 = "01/24/2007"
        d2 = "01/21/2008"
        d3 = "02/29/2009"
        d4 = "02/30/2006"
        d5 = "02/28/2006"
        d6 = "02/29/2006"
        self.assertEqual(treys_bonus_solution(d1, d2, d3), d1)
        self.assertEqual(treys_bonus_solution(d1, d2, d3, d4), d4)
        self.assertEqual(treys_bonus_solution(d1, d2, d3, d4, d5, d6), d5)
